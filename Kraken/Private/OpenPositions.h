#ifndef KRAKEN_OPENPOSITIONS_H_
#define KRAKEN_OPENPOSITIONS_H_
...
class OpenPositions {
public:
	OpenPositions(struct kraken_api **kr_api, const char* txid);
	struct Position
	{
		const char* txid; //transaction id
	...
	struct Position getPositionInfo();
